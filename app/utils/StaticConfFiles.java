...
public class StaticConfFiles {
	...
	static List<String> allUnitsConffiles=new ArrayList<>();
	...
	public static List<String> loadAllUnitsConf()
	{
		allUnitsConffiles.add(u_comodo_charger);
		allUnitsConffiles.add(u_pureblade_enforcer);
		allUnitsConffiles.add(u_fire_spitter);	
		allUnitsConffiles.add(u_silverguard_knight );
		allUnitsConffiles.add(c_truestrike );
		allUnitsConffiles.add(u_azure_herald);
		allUnitsConffiles.add(u_ironcliff_guardian);
		allUnitsConffiles.add(u_azurite_lion);
		allUnitsConffiles.add(c_sundrop_elixir);
		allUnitsConffiles.add(u_hailstone_golem);
		allUnitsConffiles.add(u_silverguard_knight );
		allUnitsConffiles.add(u_fire_spitter);
		allUnitsConffiles.add(u_comodo_charger);
		allUnitsConffiles.add(u_pureblade_enforcer);
		...
		allUnitsConffiles.add(u_rock_pulveriser);
		allUnitsConffiles.add(u_bloodshard_golem);
		allUnitsConffiles.add(c_staff_of_ykir);
		allUnitsConffiles.add(u_blaze_hound );
		allUnitsConffiles.add(u_windshrike );
		allUnitsConffiles.add(u_pyromancer);
		allUnitsConffiles.add(u_serpenti);	
		allUnitsConffiles.add(c_entropic_decay);
		allUnitsConffiles.add(u_planar_scout);
		allUnitsConffiles.add(u_hailstone_golemR);
		allUnitsConffiles.add(u_rock_pulveriser);
		allUnitsConffiles.add(u_bloodshard_golem);
		allUnitsConffiles.add(c_staff_of_ykir);
		allUnitsConffiles.add(u_blaze_hound );
